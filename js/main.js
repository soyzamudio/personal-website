...
jz.controller("ZamudioController", ['$scope', function($scope) {
  ...
  $scope.portfolio = [
    ...
    { title: "iOS Calculator", category: "Web", website: "https://soyzamudio.github.io/iOS-Calculator-Javascript/", image: "img/calc-app.jpg", techs: 'JavaScript jQuery HTML/CSS'},
